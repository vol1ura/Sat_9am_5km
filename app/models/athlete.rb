...
class Athlete < ApplicationRecord
  ...
  has_many :wallet_pass_registrations, dependent: :destroy
  ...
  after_commit :refresh_wallet_passes, if: -> { saved_change_to_going_to_event_id? || saved_change_to_stats? }
