...
class AddFunrunBadges < ActiveRecord::Migration[7.0]
  def change
    Badge.find_or_create_by!(id: 23) do |badge|
      ...
      badge.conditions =
        'Волонтёр или участник забега в Кузьминках, который проводится совместно с брендом GRI и ' \
        'посвящён зимней коллекции "Маяк".'
    ...
    Badge.find_or_create_by!(id: 24) do |badge|
      ...
      badge.conditions =
        'Волонтёр или участник забега в Олимпийской Деревне. ' \
        'Бейджик посвящён пятилетию парковых забегов в Олимпийской Деревне.'
