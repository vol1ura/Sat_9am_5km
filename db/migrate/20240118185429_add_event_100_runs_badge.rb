...
class AddEvent100RunsBadge < ActiveRecord::Migration[7.1]
  def up
    Badge.find_or_create_by!(id: 46) do |badge|
      ...
      badge.conditions = 'Награда вручается всем участникам и волонтёрам локации, которая зафиксировала сто забегов на платформе S95. Сто суббот поддерживаем друг друга. Бежим дальше!'
